    ...
    <div className="space-y-10 animate-gemini">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 gemini-card p-8 rounded-3xl flex flex-col dark:bg-slate-800 dark:border-slate-700">
          ...
          <button onClick={() => setLocation('/history')} className="mt-6 w-full py-3 text-sm font-bold text-slate-500 dark:text-slate-400 hover:text-primary transition-colors flex items-center justify-center gap-1 border-t border-slate-50 dark:border-slate-700 pt-4">
